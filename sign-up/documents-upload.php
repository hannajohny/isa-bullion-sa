<?php
/* Template Name: Signup - Documents Upload */
?>
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="account_form hswrap col flex-column d-flex justify-content-center">
                ...
                <script src="<?php echo get_template_directory_uri() . '/dist/js/hubspot-personal-account-documents.js'?>" type="text/javascript">
                </script>
            </div>
        </div>
