...
<div class="bg-light pt-60 pb-30">
    <?php 
        if($image) {
            ?>
    <div class="page-banner single-news-views" style="background-image: url(<?php echo $image[0]; ?>);"></div>
    <?php
            } else {
                ?>
    <div class="page-banner single-article default-banner"></div>
    <?php
            }
    ...
    ?>
    <div class="container">
        <div class="article-content-wr bp-card-shadow rounded-corners">
            <div class="d-flex mb-20">
                <?php 
                    if ($categories && !is_wp_error($categories)) {
                        foreach ($categories as $category) {
                    ?>
                <div class="bp-chip bg-primary mr-10"><?php echo esc_html($category->name);  ?></div>
                <?php
                        }
                    }
                ?>
            </div>
            <div class="text-grey text-small text-strong mb-10"><?php echo get_the_date('d F Y'); ?></div>
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <h1 class="text-large text-strong p-0 m-0"><?php the_title(); ?></h1>
                </div>
            </div>

            <div class="text-strong mt-20">Share</div>
            ...
            <div class="bp-line mt-30 mb-30"></div>
    ...
    <div class="container mt-40 mb-40">
        <div class="text-strong text-medium">Latest articles</div>
